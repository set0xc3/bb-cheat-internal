...
int CheatEngine::GetGameMode()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.World.GameMode);
		b = false;
	}
...
DWORD CheatEngine::GetLDeath()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.Local.Death);
		b = false;
	}
...
int CheatEngine::GetLTeam()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.Local.Team);
		b = false;
	}
...
int CheatEngine::GetLTeamZombie()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.Local.TeamZombie);
		b = false;
	}
...
int CheatEngine::GetIsMenu()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.Local.Menu);
		b = false;
	}
...
Vector3 CheatEngine::GetCoords()
{
	...
	static bool b = true;
	if (b) {
		dwAddr = Memory::FindDMAAddy(this->GetAddress(KeyPattern::Controll), this->GetOffset.Local.Coords);
		b = false;
	}

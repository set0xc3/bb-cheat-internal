...
public:
	...
	struct GetOffset
	{
		...
		struct Entity
		{
			...
			std::vector<unsigned int> Head = { 0x5C, 0xC, 0x0, 0x104, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> Body = { 0x5C, 0xC, 0x0, 0x100, 0x8, 0x34, 0x60 };

			std::vector<unsigned int> LArm1 = { 0x5C, 0xC, 0x0, 0x108, 0x10, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> LArm2 = { 0x5C, 0xC, 0x0, 0x108, 0x14, 0x8, 0x34, 0x60 };

			std::vector<unsigned int> RArm1 = { 0x5C, 0xC, 0x0, 0x10C, 0x10, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> RArm2 = { 0x5C, 0xC, 0x0, 0x10C, 0x14, 0x8, 0x34, 0x60 };

			std::vector<unsigned int> LLeg1 = { 0x5C, 0xC, 0x0, 0x110, 0x10, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> LLeg2 = { 0x5C, 0xC, 0x0, 0x110, 0x14, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> LLeg3 = { 0x5C, 0xC, 0x0, 0x110, 0x18, 0x8, 0x34, 0x60 };

			std::vector<unsigned int> RLeg1 = { 0x5C, 0xC, 0x0, 0x114, 0x10, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> RLeg2 = { 0x5C, 0xC, 0x0, 0x114, 0x14, 0x8, 0x34, 0x60 };
			std::vector<unsigned int> RLeg3 = { 0x5C, 0xC, 0x0, 0x114, 0x18, 0x8, 0x34, 0x60 };
		};
		Entity Entity;
	};
	GetOffset GetOffset;

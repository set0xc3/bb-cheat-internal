	...
	if (_renderType != RenderType::None)
	{
		...
		else if (_renderType == RenderType::OpenGL)
		{
			...
			const char* const methodsNames[] = {
				"wglSwapBuffers", "glAccum", "glAlphaFunc", "glAreTexturesResident", "glArrayElement", "glBegin", "glBindTexture", "glBitmap", "glBlendFunc", "glCallList", "glCallLists", "glClear", "glClearAccum",
